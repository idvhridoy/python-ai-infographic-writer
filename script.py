...
def generate_infographic_content(product_name):
    ...
    """
    prompt = f"""
    Create a set of 5 concise, professional infographic points for the skincare product '{product_name}'. 
    Each point should be short, clear, and focused on a key benefit, feature, or usage tip, suitable for visual infographics:
    - Product Name:
